...
Реализация интернет-магазин с товарами для веб-разработчика. Которая показывает взаимодействие с сервером(прописаным статически в файле .env) по api.
...
https://github.com/enclosser/web-larek-frontend
